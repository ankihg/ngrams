...
fs.readFile('./text.txt', (err, contents) => {
    ...
    var _2gramCounts = natural.NGrams.ngrams(contents.toString(), 2, START, END)
        .reduce((hash, _3gram) => {
    ...
    var _3gramCounts = natural.NGrams.ngrams(contents.toString(), 3, START, END)
        .reduce((hash, gram) => {
    ...
    // console.log('_3gramsByStart', _3gramsByStart);
